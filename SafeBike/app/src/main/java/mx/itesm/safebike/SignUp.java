...
public class SignUp extends AppCompatActivity {
    ...
    private EditText userName, userPassword, userEmail, userBike;
    private Button regButton;
    private TextView userLogin;
    private FirebaseAuth firebaseAuth;
    private ImageView userProfilePic; //Still to implement im to lazy for this
    String email, name, bike, password;
    ...
    private void setupUIViews(){
        ...
        userBike = (EditText)findViewById(R.id.etBike);
    ...
    private Boolean validate(){
        ...
        bike = userBike.getText().toString();


        if(name.isEmpty() || password.isEmpty() || email.isEmpty() || bike.isEmpty()){
    ...
    private void sendUserData(){
        ...
        UserProfile userProfile = new UserProfile(bike, email, name);
